...
class MuDoCo_Plugin_Cookie implements MuDoCo_Plugin_Interface {
  ...
  protected function getSessionStorageClass() {
    global $mudoco_conf;
    if (isset($mudoco_conf['MUDOCO_PLUGIN_COOKIE_SESSION_STORAGE_CLASS'])) {
      return $mudoco_conf['MUDOCO_PLUGIN_COOKIE_SESSION_STORAGE_CLASS'];
    }
